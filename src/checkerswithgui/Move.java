...
public class Move {
    ...
    public Move(Move temp) { // constructor for copying an object
    ...
    public Move(int r, int c, int capturedPiece) {
    ...
    public boolean isIdentical(Move m) { // check if the move made is correct
